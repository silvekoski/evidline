...
const pageTitles: Record<string, string> = { runs: "Runs", sources: "Sources", claims: "Review claims", "open-questions": "Open questions", spec: "Data spec", connectors: "Connectors" };
